...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('')?>">Appointments</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-12 border-right">
                    <div class="d-flex flex-column align-items-center p-3 py-5">    
                        <div class="card">
                                <div class="card-body">
                                <form action="<? echo site_url('PractitionerDetails/create')?>" method="POST">
                                    ...
                                    <div class="row g-3 align-items-center py-3 px-2">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" name="practitionerid" class="form-control">
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="form-group p-2">
                                        ...
                                        <input type="file" name="myfile" class="form-control-file py-1" id="fileupload">
                                    </div>
